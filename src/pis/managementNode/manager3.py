...
import pis.messaging.ratatraffic as rata
from pis.messaging.telemetry import Connection 
from pis.utils.database.sqlite import PersistentConnection
import pis.utils.database.model.display as dao
from collections import defaultdict
from pis.managementNode import announcement_manager
from pis.utils.Event import observable
from pis.utils.Tree import BPTree, query
from pis.managementNode import passing_train
...
class Manager:
    ...
    def parse(self, response, station):
        ...
        # B+ Tree to sort and query base train info and train timetables. Adjust the factor based on the amount of train rows.
        ...
        for train in response:
            ...
            # return scheduledTime as the key with [-1] index on lambda
        ...
        # 9999999099 equals infinity-timestamp
        for s in query.select(schedules.range_query(timestamp, "9999999099"), 
            ...
            s['runningCurrently'] = trains.find(trainNumber).get("runningCurrently", "")
